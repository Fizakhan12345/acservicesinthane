          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-3">
              <a
                ...
                className="flex items-center justify-center w-9 h-9 rounded-full bg-white/10 hover:bg-[#25D366] text-slate-200 hover:text-white transition-colors"
              >
                <WhatsAppIcon className="w-4 h-4 fill-current" />
              </a>
              <a
                ...
                className="flex items-center justify-center w-9 h-9 rounded-full bg-white/10 hover:bg-[#1877F2] text-slate-200 hover:text-white transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center justify-center w-9 h-9 rounded-full bg-white/10 hover:bg-gradient-to-tr hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] text-slate-200 hover:text-white transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center justify-center w-9 h-9 rounded-full bg-white/10 hover:bg-[#0A66C2] text-slate-200 hover:text-white transition-colors"
              >
